...
public class PyCourse_lesson_two_Activity extends AppCompatActivity {


    static PyCourse_lesson_two_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_course_lesson_two);
        ...
        String videopath = "android.resource://" + getPackageName() + "/" + R.raw.print_your_name;
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PyCourse_lesson_two_Activity.this,PyCourse_lesson_three_Activity.class);
    ...
    public static PyCourse_lesson_two_Activity getActivityInstance()
    {
        return INSTANCE;
    }
