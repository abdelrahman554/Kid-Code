...
public class PyCourse_lesson_five_Activity extends AppCompatActivity {

    static PyCourse_lesson_five_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_course_lesson_five);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PyCourse_lesson_five_Activity.this,Get_Certificate_Activity.class);
    ...
    public static PyCourse_lesson_five_Activity getActivityInstance()
    {
        return INSTANCE;
    }
