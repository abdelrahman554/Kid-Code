...
public class JavaCourse_lesson_one_Activity extends AppCompatActivity {

    static JavaCourse_lesson_one_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_course_lesson_one);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(JavaCourse_lesson_one_Activity.this,JavaCourse_lesson_two_Activity.class);
    ...
    public static JavaCourse_lesson_one_Activity getActivityInstance()
    {
        return INSTANCE;
    }
