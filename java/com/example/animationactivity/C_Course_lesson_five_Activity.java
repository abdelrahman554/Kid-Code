...
public class C_Course_lesson_five_Activity extends AppCompatActivity {

    static C_Course_lesson_five_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ccourse_lesson_five);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(C_Course_lesson_five_Activity.this,Get_Certificate_Activity.class);
    ...
    public static C_Course_lesson_five_Activity getActivityInstance()
    {
        return INSTANCE;
    }
