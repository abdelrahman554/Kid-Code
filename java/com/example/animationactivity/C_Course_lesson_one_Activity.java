...
public class C_Course_lesson_one_Activity extends AppCompatActivity {

    static C_Course_lesson_one_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ccourse_lesson_one);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(C_Course_lesson_one_Activity.this,C_Course_lesson_two_Activity.class);
    ...
    public static C_Course_lesson_one_Activity getActivityInstance()
    {
        return INSTANCE;
    }
