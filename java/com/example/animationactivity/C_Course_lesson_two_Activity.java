...
public class C_Course_lesson_two_Activity extends AppCompatActivity {

    static C_Course_lesson_two_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ccourse_lesson_two);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(C_Course_lesson_two_Activity.this,C_Course_lesson_three_Activity.class);
    ...
    public static C_Course_lesson_two_Activity getActivityInstance()
    {
        return INSTANCE;
    }
