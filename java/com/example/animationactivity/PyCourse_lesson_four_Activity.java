...
public class PyCourse_lesson_four_Activity extends AppCompatActivity {

    static PyCourse_lesson_four_Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_course_lesson_four);
        ...
        nextlesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PyCourse_lesson_four_Activity.this,PyCourse_lesson_five_Activity.class);
    ...
    public static PyCourse_lesson_four_Activity getActivityInstance()
    {
        return INSTANCE;
    }
